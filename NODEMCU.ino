...
// strings para o envio do Header HTTP
...
// definicao da variavel de leitura da resposta do servidor
String resposta = "";
...
void setup()
{
  ...
  lcd.print("NODEMCU - OFFICE"); // ESCREVE O TEXTO NA SEGUNDA LINHA DO DISPL
